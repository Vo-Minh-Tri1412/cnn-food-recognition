...
def main() -> None:
    ...
    parser.add_argument("--old-weight", type=int, default=4)
    parser.add_argument("--reviewed-weight", type=int, default=1)
    parser.add_argument("--max-reviewed-per-old", type=float, default=2.0, help="Cap reviewed unique images to N times old unique images per class. Use 0 to disable.")
