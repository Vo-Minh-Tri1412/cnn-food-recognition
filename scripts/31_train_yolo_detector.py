...
def main() -> None:
    ...
    shutil.copy2(best_path, args.model_out)
    try:
        metrics = YOLO(str(args.model_out)).val(data=str(args.data), imgsz=args.imgsz, batch=args.batch, workers=args.workers)
    ...
    summary = {
        ...
        "model_out": relative_or_absolute(args.model_out),
        "epochs": args.epochs,
        "imgsz": args.imgsz,
        "batch": args.batch,
        "patience": args.patience,
